...
<form id="form2" name="form2" method="post" action="delcomment.php">
<td><input type="submit" name="Submit3" value="Delete" /> </td></form>
<form id="form2" name="form2" method="post" action="delonecom.php">
<td><input type="submit" name="Submit3" value="Delete last" /> </td></form>
</tr>
</table>
<table width="400" border="0" align="center" cellpadding="3"
cellspacing="0">
